...
void CSystemThread::ServiceCall(uint32_t index)
{
    ...
    case SvcCall_StartThread:
        ...
        break;
    case SvcCall_SleepThread:
        HleKernel.SleepThread(Arm64Opcode::ARM64_REG_X0);
        VoidRes = true;
        break;
    ...
    case SvcCall_WaitSynchronization:
        ...
        break;
    case SvcCall_ArbitrateLock:
        Result = HleKernel.ArbitrateLock(Reg.Get32(Arm64Opcode::ARM64_REG_W0), Reg.Get64(Arm64Opcode::ARM64_REG_X1), Reg.Get32(Arm64Opcode::ARM64_REG_W2));
        break;
