...
public:
    ...
    static void Extr(CInterpreterCPU & Cpu, const Arm64Opcode & Op);
    ...
    static void Fcvtps(CInterpreterCPU & Cpu, const Arm64Opcode & Op);
    ...
    static void Fneg(CInterpreterCPU & Cpu, const Arm64Opcode & Op);
    ...
    static void Ldpsw(CInterpreterCPU & Cpu, const Arm64Opcode & Op);
    ...
    static void Ldursw(CInterpreterCPU & Cpu, const Arm64Opcode & Op);
    ...
    static void Ucvtf(CInterpreterCPU & Cpu, const Arm64Opcode & Op);
