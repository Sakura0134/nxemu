...
void CInterpreterCPU::Execute()
{
    ...
    while (!Done)
    {
        ...
        case Arm64Opcode::ARM64_INS_FCVTMS: Arm64Op::Fcvtms(*this, op); break;
        case Arm64Opcode::ARM64_INS_FCVTPS: Arm64Op::Fcvtps(*this, op); break;
        ...
        case Arm64Opcode::ARM64_INS_FMIN: Arm64Op::Fmin(*this, op); break;
        ...
        case Arm64Opcode::ARM64_INS_LDRSH: Arm64Op::Ldrsh(*this, op); break;
